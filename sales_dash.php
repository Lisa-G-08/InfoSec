...
<title>QuickBooks Sales Dashboard</title>
...
<body>
  ...
  <div class="content-view">
    <div class="welcome-message">Welcome, Sales Manager!</div>
    <div class="admin-content">
      <p>This is the sales manager's home page. Here, you can manage order and order details tables and view product details. Use the links on the left sidebar to navigate through different sections.</p>
...
var profileLink = document.getElementById('salesdash_txt');

// Check if the current URL contains 'sales_dash.php'
if (currentUrl.includes('sales_dash.php')) {
